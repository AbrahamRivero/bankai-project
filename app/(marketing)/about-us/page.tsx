  ...
  return (
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 px-6 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
        Dale un toque <span className="text-blue-600">diferente</span> a tu vida
      ...
      <p className="mt-5 max-w-prose text-zinc-700 text-lg sm:text-base">
        ...
        amplia gama de figuras de anime, manga, películas, series y videojuegos
        de importación. Nuestro <span className="font-semibold">objetivo</span>{" "}
        es proporcionar a nuestros clientes artículos únicos y exclusivos.
      </p>
